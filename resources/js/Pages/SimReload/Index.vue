...
const selectCarrier = (carrier) => {
  const carrierRoutes = {
    'Mobitel': '/sim-reload/mobitel',
    'Dialog': '/sim-reload/dialog',
    'Airtel': '/sim-reload/airtel',
    'Hutch': '/sim-reload/hutch'
  };
  
  router.visit(carrierRoutes[carrier]);
};
</script>
